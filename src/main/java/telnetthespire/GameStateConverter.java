...
import telnetthespire.patches.UpdateBodyTextPatch;
...
public class GameStateConverter {
    ...
    /**
     * Creates a JSON representation of the status of TelnetTheSpire that will be sent to the external process.
     ...
     * @return A string containing the JSON representation of TelnetTheSpire's status
     */
